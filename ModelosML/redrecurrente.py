...
# =============================================
# RED NEURONAL RECURRENTE SIMPLE (RNN)
# =============================================
...
# =============================================
# PASO 2: Definir y entrenar modelo RNN
# =============================================

print("\nEntrenando modelo RNN...\n")

rnn_model = Sequential([
    SimpleRNN(units=12, activation='sigmoid', input_shape=(1, X_train.shape[2])),
...
plt.title('Pérdida MSE - Entrenamiento vs Validación (RNN)')
plt.xlabel('Épocas')
plt.ylabel('Pérdida')
plt.legend()
plt.grid(True)
...
plt.title('Potencia real vs predicha (RNN)')
...
plt.title('Potencia predicha por la red RNN')
plt.xlabel('Índice de muestra')
plt.ylabel('Potencia (mW)')
plt.grid(True)
plt.tight_layout()
